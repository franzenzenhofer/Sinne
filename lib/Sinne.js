...
(function() {
  var Sinne, default_options, getUserX;
  ...
  getUserX = function(video_support, audio_support, success, error, options) {
    var element, key, options_, success_, val, value;
  ...
  Sinne.getUserAudio = function(success, error, options) {
    var video_support;
    video_support = false;
    if ((options != null ? options.video : void 0) === true) {
      video_support = true;
    }
    return getUserX(video_support, true, success, error, options);
  };
